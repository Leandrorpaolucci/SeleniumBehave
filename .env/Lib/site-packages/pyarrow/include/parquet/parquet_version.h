...
#define PARQUET_VERSION_MAJOR 14
#define PARQUET_VERSION_MINOR 0
#define PARQUET_VERSION_PATCH 1

#define PARQUET_SO_VERSION "1400"
#define PARQUET_FULL_SO_VERSION "1400.1.0"

// define the parquet created by version
#define CREATED_BY_VERSION "parquet-cpp-arrow version 14.0.1"
